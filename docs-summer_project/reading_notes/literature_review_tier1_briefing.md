...
## Terminology watch-list (same word, three meanings)

| Term | #5 | #7 | #4 |
|---|---|---|---|
| "correctness" | cited doc supports the sentence | harmonic mean (F1) of citation P/R | answer content matches gold |

**Rule adopted:** every metric is re-checked against the definition in the paper at hand.

## Next steps

- Remaining Tier-1: **#18** (citation masking-and-recovery protocol) — annotation-free attribution evaluation, complementary to #5.
- Implementation follow-ups: calibrated parametric vote (#20); ALCE citation P/R behind the NIAH pipeline (#4); positioning paragraph contrasting reranking-stage corroboration with Astute RAG (#19).
