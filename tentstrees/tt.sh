...
# gcc tt9.c driver.c -DBSIZE=9 -o tt9_d -Wall -Wextra -pedantic -std=c99 -Wfloat-equal -Wvla -g3 -fsanitize=address -fsanitize=undefined
# if [[ ! -e tt9_d ]]; then
#    echo "ERROR : Failed to make tt9_d with gcc?"
#    exit
# fi
